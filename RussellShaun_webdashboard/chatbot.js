...
const chatbotResponses = {
    ...
    'burnout': 'Burnout is a state of emotional, physical, and mental exhaustion. If you\'re experiencing burnout, consider taking breaks, setting work boundaries, and talking to a mental health professional.',
    ...
    'mental health': 'Your mental health is important. If you\'re struggling, please reach out to a counselor, therapist, or mental health professional. There\'s no shame in seeking help.',
...
const defaultResponses = [
    'That\'s an interesting question about wellness. Can I help with something specific about sleep, stress, exercise, or burnout?',
    'I\'m here to help with wellness topics. Try asking me about sleep, stress management, exercise, or burnout.',
    'I\'m a wellness chatbot. I can provide advice on stress, sleep, exercise, and preventing burnout. What would you like to know?',
];
...
window.addEventListener('load', () => {
    if (chatHistory.children.length === 0) {
        addMessage('Hello! I\'m your wellness assistant. Ask me anything about sleep, stress, exercise, preventing burnout, or general wellness tips!', false);
    }
});
